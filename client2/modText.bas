...
End Sub
Public Sub AddTextCombat(ByVal Msg As String, ByVal Color As Integer)
Dim s As String
  
    s = vbNewLine & Msg
    frmMirage.txtCombat.SelStart = Len(frmMirage.txtCombat.Text)
    frmMirage.txtCombat.SelColor = QBColor(Color)
    frmMirage.txtCombat.SelText = s
    frmMirage.txtCombat.SelStart = Len(frmMirage.txtCombat.Text) - 1
...
End Sub
Public Sub AddTextActions(ByVal Msg As String, ByVal Color As Integer)
Dim s As String

    s = vbNewLine & Msg
    frmMirage.txtActions.SelStart = Len(frmMirage.txtActions.Text)
    frmMirage.txtActions.SelColor = QBColor(Color)
    frmMirage.txtActions.SelText = s
    frmMirage.txtActions.SelStart = Len(frmMirage.txtActions.Text) - 1
End Sub
...
Dim s As String
    ...
    If frmMirage.SSTab1.Tab = 1 Then
